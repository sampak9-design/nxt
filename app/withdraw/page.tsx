    ...
    <div className="min-h-screen" style={{ background: "#f4f6f8", color: "#111" }}>
      ...
      <div className="max-w-5xl mx-auto px-4 py-10">
        ...
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-gray-800">Retirada de fundos</h1>
        ...
        {submitted ? (
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-10 text-center max-w-md mx-auto">
            ...
            <p className="text-gray-500 text-sm mb-6">Sua retirada de <strong>R$ {amountNum.toLocaleString("pt-BR", { minimumFractionDigits: 2 })}</strong> foi solicitada e será processada em {selected.time}.</p>
            <button onClick={() => { setSubmitted(false); setAmount(""); setPixKey(""); }} className="px-6 py-2 rounded font-semibold text-white text-sm" style={{ background: "#f97316" }}>
              Nova retirada
            </button>
          </div>
        ) : (
          <div className="flex gap-6 items-start">
            {/* Left: methods list */}
            <div className="w-64 flex-shrink-0 bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
            ...
            <div className="flex-1 bg-white rounded-xl shadow-sm border border-gray-200 p-8">
              {!canWithdraw ? (
                <div className="flex flex-col items-center py-8 gap-4">
                  ...
                  <p className="text-sm text-gray-400">Você não pode retirar fundos porque seu saldo é 0.</p>
                  <button
                    onClick={() => window.location.href = "/traderoom"}
                    className="px-8 py-3 rounded-lg font-bold text-white mt-2"
                ...
                <div className="flex flex-col gap-5 max-w-md">
                  ...
                  <div>
                    ...
                    <input type="number" placeholder="0,00" value={amount} onChange={e => setAmount(e.target.value)} min="1" max={realBalance}
